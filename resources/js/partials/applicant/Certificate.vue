          ...
          <div class="justify-between w-full">
            ...
            <a :href="certificate.link">
              <div class="flex text-[5742F5] gap-x-2">
                ...
                <p class="font-light">Link Sertifikat</p>
              </div>
            </a>
          </div>
        ...
        <form @submit.prevent="addApplicantCertificate">
          ...
          <div class="mb-4">
            ...
            <div class="flex flex-wrap sm:flex-nowrap gap-4 sm:gap-x-12">
              <TextInput id="startMonth" v-model="addForm.start_month" type="text" class="mt-1 block w-full sm:w-auto" :placeholder="'Bulan'" required></TextInput>
              <TextInput id="startYear" v-model="addForm.start_year" type="text" class="mt-1 block w-full sm:w-auto" :placeholder="'Tahun'" required> </TextInput>
              <TextInput id="endMonth" v-model="addForm.end_month" type="text" class="mt-1 block w-full sm:w-auto" :placeholder="'Bulan'" required></TextInput>
              <TextInput id="endYear" v-model="addForm.end_year" type="text" class="mt-1 block w-full sm:w-auto" :placeholder="'Tahun'" required> </TextInput>
            </div>
          </div>
          <div class="mb-4">
