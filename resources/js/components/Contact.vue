    ...
    <main class="py-14">
      <div class="max-w-screen-xl mx-auto px-4 text-gray-600 md:px-8">
        <div class="max-w-xl space-y-3">
          ...
          <p>
            Our always-ready customer service is here to assist you. Let us know how we can help.
          </p>
        </div>
        <div>
        ...
        contactMethods: [
          {
            ...
            `,
            contact: "Wagir, Malang, Indonesia.",
            title: "Our office"
          },
          {
            icon: `
